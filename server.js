...
app.get('/signup', function (req, res) {
  res.render('signup', { root: path.join(__dirname, '../client/views') });
});

app.get('/recovery', (req, res) => {
  res.render('recovery', { root: path.join(__dirname, '../client/views') });
});
app.get('/user-error', (req, res) => {
res.render('user-error', { root: path.join(__dirname, '../client/views') });
});
app.get('/index-error', (req, res) => {
res.render('index-error', { root: path.join(__dirname, '../client/views') });
});
...
app.get('/ser', (req, res) => {
res.render('ser', { root: path.join(__dirname, '../client/views') });
});
app.get('/login', (req, res) => {
  res.render('login', { root: path.join(__dirname, '../client/views') });
});
